      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="md:flex md:items-center md:justify-between">
          <div className="flex justify-center md:justify-start gap-x-2 items-center">
            <div className="flex h-6 w-6 items-center justify-center rounded bg-brand-50">
          ...
          <div className="mt-4 flex justify-center space-x-6 md:mt-0">
            <a href="#" className="text-xs text-gray-500 hover:text-gray-900">Términos</a>
            <a href="#" className="text-xs text-gray-500 hover:text-gray-900">Privacidad</a>
            <a href="#" className="text-xs text-gray-500 hover:text-gray-900">Seguridad</a>
            <a href="#" className="text-xs text-gray-500 hover:text-gray-900">Contacto</a>
          </div>
        ...
        <div className="mt-8 md:order-1">
          <p className="text-center text-xs leading-5 text-gray-400">
            &copy; 2026 AgendaAbierta. Todos los derechos reservados. Hecho con <span className="text-brand-600">♥</span> para dueños de negocios.
          </p>
        </div>
      </div>
    </footer>
